...
#
directory = "/home/piotr/praca/coal_fluctu_dim/well_mixed_cell_size/data/Wang/LCM/GA17_from_libcloudphxx/GA17_Np1e0_nx454_eps1_dt0.1var_Wang_HallDavis_rmr100"
data[directory+ "/"] = "LCM Np1e0 nx454 rmr100, var dt 0.1, GA17 libcloudphxx, HallDavis"
#
#directory = "/home/piotr/praca/coal_fluctu_dim/well_mixed_cell_size/data/Wang/LCM/GA17_from_libcloudphxx/GA17_Np1e0_nx100_eps1_dt0.1var_Wang_HallDavis_rmr100"
#data[directory+ "/"] = "LCM Np1e0 nx100 rmr100, var dt 0.1, GA17 libcloudphxx, HallDavis"
###
directory = "/home/piotr/praca/coal_fluctu_dim/well_mixed_cell_size/data/Wang/LCM/zero_dim/GA17_Np1e6_nx1_eps1_dt0.1var_Wang_HallDavis_rmr100"
data[directory+ "/"] = "LCM Np1e6 nx1 rmr100, var dt 0.1, GA17 libcloudphxx, HallDavis"
#
#directory = "/home/piotr/praca/coal_fluctu_dim/well_mixed_cell_size/data/Wang/LCM/zero_dim/GA17_Np1e6_nx1_eps1_dt0.1var_Wang_HallDavis_normr"
...
## -- Wang ---
  if plot=="tau":
    efm_data = np.genfromtxt("/home/piotr/praca/coal_fluctu_dim/well_mixed_cell_size/data/Wang/EFM/dt0.10_rq0 9.3_xmw 1.0_scal10.0_isw3_cut 20._rmr****_rain_ratio.out", unpack=True)
    ax.plot(efm_data[0], efm_data[1], label="EFM_normr dt0.1")
    efm_data = np.genfromtxt("/home/piotr/praca/coal_fluctu_dim/well_mixed_cell_size/data/Wang/EFM/dt 0.1_rq0 9.3_xmw 1.0_scal10.0_isw3_cut 20._rmr250._rain_ratio.out", unpack=True)
    ax.plot(efm_data[0], efm_data[1], label="EFM_rmr250 dt0.1")
    efm_data = np.genfromtxt("/home/piotr/praca/coal_fluctu_dim/well_mixed_cell_size/data/Wang/EFM/dt 0.1_rq0 9.3_xmw 1.0_scal10.0_isw3_cut 20._rmr100._rain_ratio.out", unpack=True)
    ax.plot(efm_data[0], efm_data[1], label="EFM_rmr100 dt0.1")
    efm_data = np.genfromtxt("/home/piotr/praca/coal_fluctu_dim/well_mixed_cell_size/data/Wang/EFM/dt0.10_rq0 9.3_xmw 1.0_scal15.0_isw3_cut 20._rmr100._rain_ratio.out", unpack=True)
    ax.plot(efm_data[0], efm_data[1], label="EFM_rmr100 dt0.1 scal15")
    efm_data = np.genfromtxt("/home/piotr/praca/coal_fluctu_dim/well_mixed_cell_size/data/Wang/EFM/dt0.10_rq0 9.3_xmw 1.0_scal40.0_isw3_cut 20._rmr100._1000bins_rain_ratio.out", unpack=True)
    ax.plot(efm_data[0], efm_data[1], label="EFM_rmr100 dt0.1 scal40 1000bins")
  plt.xlim([2000, 5000])
  
  plt.legend()
  fig.savefig("/home/piotr/praca/coal_fluctu_dim/well_mixed_cell_size/img/series/Wang_series_"+plot+".png")
